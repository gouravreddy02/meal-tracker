...
window.PLAN = {
  ...
  // cb=carbs, f=fat, fi=fiber (grams). Slots render in the order listed below; the
  // slot name is the heading shown in the Quick add tab. Add/edit/move foods
  // freely, and add or rename slots by editing the keys.
  foods: {
    "Before workout": [
